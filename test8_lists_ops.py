...
print(lst[3])           #--> print item of given index
...
print('pop() : ')
print(lst.pop(2))              #--> remove given index's item from list, and return that indexed item from list
print(lst)

print(lst.remove('train'))     #--> remove given item's value from list, and return None, not an item like pop
print(lst)
